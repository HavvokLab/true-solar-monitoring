...
type Plant struct {
	...
	GridConnectionDate *string  `json:"gridConnectionDate,omitempty"`
}

func (p *Plant) GetPlantCode(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}

	return pointy.StringValue(p.PlantCode, value)
}

func (p *Plant) GetPlantName(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (p *Plant) GetPlantAddress(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (p *Plant) GetLongitude(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (p *Plant) GetLatitude(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (p *Plant) GetCapacity(defaultValue ...float64) float64 {
	value := 0.0
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (p *Plant) GetContactPerson(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (p *Plant) GetContactMethod(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (p *Plant) GetGridConnectionDate(defaultValue ...string) string {
	value := ""
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}

	return pointy.StringValue(p.GridConnectionDate, value)
}
...
func (d *GetPlantListData) GetTotal(defaultValue ...int) int {
	value := 0
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}
...
func (d *GetPlantListData) GetPageCount(defaultValue ...int) int {
	value := 0
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}

	return pointy.IntValue(d.PageCount, value)
}

func (d *GetPlantListData) GetPageNo(defaultValue ...int) int {
	value := 0
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}

	return pointy.IntValue(d.PageNo, value)
}

func (d *GetPlantListData) GetPageSize(defaultValue ...int) int {
	value := 0
	if len(defaultValue) > 0 {
		value = defaultValue[0]
	}

	return pointy.IntValue(d.PageSize, value)
}
